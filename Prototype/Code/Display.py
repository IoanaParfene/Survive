...
def display_game_time(game_state):
    ...
    pygame.draw.rect(Config.screen, (0, 0, 0), (10, 20, 490, 40))
    Config.screen.blit(font.render(time_information, True, (255, 255, 255)), (20,20))
...
def display_game_progress(game_state):
    ...
    pygame.draw.rect(Config.screen, (0, 0, 0), (10, 65, 490, 40))
    Config.screen.blit(font.render(game_progress, True, (255, 255, 255)), (20, 65))
...
def display_status_bars(game_state):
    ...
    for status_bar in game_state.status_bars.values():
        ...
        pygame.draw.rect(Config.screen, (0, 0, 0), (status_bar[1][0]-10, status_bar[1][1], 260, 40))
        # blit the status bar text
        Config.screen.blit(font.render(str(status_bar[0]), True, (255, 255, 255)), status_bar[1])
...
def display_buttons(game_state, buttons):
    ...
    for key in Config.game_buttons[game_state.current_scene]:
        # print a background rectangle
        pygame.draw.rect(Config.screen, (0, 0, 0), (buttons[key].icon_pos[0] - 10, buttons[key].icon_pos[1], buttons[key].size[0], buttons[key].size[1]))
        # blit the status bar text
        Config.screen.blit(font.render(buttons[key].display_text, True, (255, 255, 255)), buttons[key].icon_pos)
...
def display_actions(game_state, actions):
    ...
    for key in Config.game_actions[game_state.current_scene]:
        # print a background rectangle
        pygame.draw.rect(Config.screen, (255, 255, 255), (actions[key].icon_pos[0] - 10, actions[key].icon_pos[1], actions[key].size[0], actions[key].size[1]))
        # blit the status bar text
        if "Item" in key:
            ...
            if item_number == 0:
                ...
                text = "EAT"
            Config.screen.blit(font.render(text, True, (0, 0, 0)), actions[key].icon_pos)
        elif "Travel" in key:
            ...
            Config.screen.blit(font.render(actions[key].display_text, True, (0, 0, 0)), actions[key].icon_pos)
...
def display_message(game_state, message, location, font_size, color):
    ...
    Config.screen.blit(font.render(message, True, color), location)
