...
game_location_info = {"pike_lake": {"Name": "Pike Lake", "Miles": 3, "Duration": 3, "Water Source": True, "Explorables": (4,[("flashlight",15), ("wires",25), ("empty_bottle",10), ("newspaper",15), ("duct_tape",9), ("fishing_kit",8), ("matches",8), ("first_aid_kit",10)])},
...
# Hunting and traps
hunting_trap_actions = {"set_bird_trap": {"Locations": ["muddy_road", "muddy_area", "path", "woodland"]},
...
traps = {"deadfall": {"Needed":[("rope", 1), ("wood", 1), ("bait", 1)], "HourlyTrapChance": 0.02, "Prey": "hare"},
         "fish_trap": {"Needed":[("rope", 1), ("wood", 1), ("bait", 1)], "HourlyTrapChance": 0.03, "Prey": "fish"},
         "bird_trap": {"Needed":[("rope", 1), ("wood", 1), ("bait", 1)], "HourlyTrapChance": 0.04, "Prey": "bird"}
        }
last_trap_hour = 0
...
# Screen info
start_text = "My car stopped working...\nI am in the middle of the woods and it's raining!\n There's mud all over the car tracks.\nI have to get back to the main road!"
shelter_screen_info = "I can use a trash bag to build a raincatcher to collect water during rain.\n It takes 15 minutes."
...
hunting_screen_info = "I can SET(for food) and DISMANTLE(before leaving) traps[1h].\nREQUIREMENTS: 1 wood, 1 rope, 1 bait."

# Fire
fire_starting_message = ""
fire_tool_info = {"matches": {"Name": "Matches", "SuccessRate": 1, "DestroyRate": 1.0, "ShowDestructionMessage": False},
                  "bow_drill": {"Name": "Bow Drill", "SuccessRate": 0.5, "DestroyRate": 0.03, "ShowDestructionMessage": True},
                  "fire_plow": {"Name": "Fire Plow", "SuccessRate": 0.3, "DestroyRate": 0.06, "ShowDestructionMessage": True}
                 }