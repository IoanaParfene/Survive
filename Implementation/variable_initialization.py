...
inventory_items = {"wood": {"Name": "Wood", "Weight": 3.0, "Categories": ["A", "Fi"], "Throw": True, "GetActions": None, "BarActions": None, "Description": "Wood. Burns nicely and can be used to craft different tools."},
                    ...
                    "broken_cellphone": {"Name": "Broken Cellphone", "Weight": 0.0, "Categories": ["A","G"], "Throw": True, "GetActions": None, "BarActions": None, "Description": "Would be the most important survival item, except the screen is completely black. Smart phones..."},
                    ...
                    "bandages": {"Name": "Bandages", "Weight": 1.0, "Categories": ["A","G"], "Throw": True, "GetActions": {"Tear": ["tinder"]}, "BarActions": {"Patch Wound": [("Condition", 20)]}, "Description": "Can be used to stop bleeding."},
                    ...
                    "wires": {"Name": "Wires", "Weight": 0.34, "Categories": ["A","G"], "Throw": True, "GetActions": {"Make Rope": ["rope","rope","rope","rope"]}, "BarActions": None, "Description": "Bundle of wires that I can use as rope."},
