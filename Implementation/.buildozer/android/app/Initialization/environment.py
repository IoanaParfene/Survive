...
def randomize_location_info(location_key):
    ...
    locations_info["Duration"] = random.randint(cs.game_location_info[location_key]["Duration"], cs.game_location_info[location_key]["Duration"]+2)
    locations_info["Water Source"] = cs.game_location_info[location_key]["Water Source"]
    # Randomize a list of explorable items
    number_explorable_items = random.randint(cs.game_location_info[location_key]["Explorables"][0]-1, cs.game_location_info[location_key]["Explorables"][0]+2)
